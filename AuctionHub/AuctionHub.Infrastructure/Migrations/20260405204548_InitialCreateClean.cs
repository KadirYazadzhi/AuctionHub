        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ApplicationUser_WalletBalance_Positive", "[WalletBalance] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollowers", x => new { x.FollowerId, x.SellerId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserFollowers_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDutchAuction = table.Column<bool>(type: "bit", nullable: false),
                    DutchDecrementAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DutchDecrementIntervalMinutes = table.Column<int>(type: "int", nullable: true),
                    LastDutchDecrement = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ParticipationFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHiddenForSender = table.Column<bool>(type: "bit", nullable: false),
                    IsHiddenForReceiver = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollowers_SellerId",
                table: "UserFollowers",
                column: "SellerId");
